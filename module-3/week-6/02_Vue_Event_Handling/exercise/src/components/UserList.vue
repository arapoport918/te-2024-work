  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        <tr>
          <td>
            <input type="checkbox" id="selectAll"/>  <!-- ALL USER SELECTION -->
          </td>
          <td>
        ...
        >
          <td>
            <input type="checkbox" v-bind:id="user.id" v-bind:value="user.id" /> <!-- INDIVIDUAL USER SELECTION -->
          </td>
    ...
    <button v-on:click="isNewUser = !isNewUser">Add New User</button>

    <form id="frmAddNewUser" v-on:submit.prevent="createNewUser" v-show="isNewUser">
      <div class="field">
