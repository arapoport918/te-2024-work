...
public class AuctionController {
    ...
    public Auction update(@PathVariable int id, @Valid @RequestBody Auction auctionToUpdate) {
        if (auctionDao.getAuctionById(id) == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Auction not found", null);
        }
        auctionDao.updateAuction(auctionToUpdate);
        return auctionDao.getAuctionById(auctionToUpdate.getId());
    }
