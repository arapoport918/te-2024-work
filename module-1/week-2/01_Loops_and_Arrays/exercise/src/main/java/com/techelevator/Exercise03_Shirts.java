...
public class Exercise03_Shirts {
    ...
    public char[] buildOrder() {
        final char SMALL_TSHIRT = 'S';
        final char MEDIUM_TSHIRT = 'M';
        final char LARGE_TSHIRT = 'L';

        char[] tshirtOrder = new char[] {SMALL_TSHIRT, SMALL_TSHIRT, SMALL_TSHIRT, MEDIUM_TSHIRT, MEDIUM_TSHIRT, LARGE_TSHIRT};
        return tshirtOrder;
    }
